        ...
        <Section id="features">
            <div className='container relative z-2'>
                <Heading className='md:max-w-md lg:max-w-4xl'
                    title="Why Ardhi? Turn Data into Decisions, Faster!" />
                <div className='flex flex-wrap gap-10 mb-10'>
                    {benefits.map((item) => (
                        <div
                            className='block relative p-0.5 bg-no-repete bg-[length:100%_100%] md:max-w-[24rem]'
                            ...
                            <div className='absolute inset-0.5 bg-n-8'
                                ...
                                <div className='absolute inset-0 opacity-0 trasition-opacity hover:opacity-15'>
                                    {item.imageUrl && (
                                        <img
                                            src={item.imageUrl}
                                            width={380}
